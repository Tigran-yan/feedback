var stars = document.getElementsByClassName("fas");
        var emoje = document.getElementById("emoje");
        ...
        stars[0].onclick = function(){
            ...
            emoje.style.transform = "translateX(0)";
        }
        ...
        stars[1].onclick = function(){
            ...
            stars[3].style.color = "#e4e4e4";
            stars[4].style.color = "#e4e4e4";
            emoje.style.transform = "translateX(-100px)";
        }
        ...
        stars[2].onclick = function(){
            ...
            stars[3].style.color = "#e4e4e4";
            stars[4].style.color = "#e4e4e4";
            emoje.style.transform = "translateX(-200px)";
        }
        ...
        stars[3].onclick = function(){
            ...
            stars[4].style.color = "#e4e4e4";
            emoje.style.transform = "translateX(-300px)";
        }
        ...
        stars[4].onclick = function(){
            ...
            emoje.style.transform = "translateX(-400px)";
        }